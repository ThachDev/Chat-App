      ...
      return Container(
        ...
        child: InkWell(
          onTap: (){
             ...
             var to_name = "";
             var to_avatar ="";
             // Kiểm tra xem người gửi có phải là người dùng hiện tại hay không
             if(item.data().from_uid == controller.token){
               // Nếu là người gửi, lấy thông tin người nhận
               to_uid = item.data().to_uid??"";
               to_name = item.data().to_name??"";
               to_avatar = item.data().to_avatar??"";
             } else{
               // Nếu không phải người gửi, lấy thông tin người gửi
  ...
  Widget build(BuildContext context) {
    return Obx(
        () => SmartRefresher(
            ...
            //--- Hiển thị widget sau khi làm mới
                ...
                SliverPadding(
                 ...
                 sliver: SliverList(
                   delegate: SliverChildBuilderDelegate(
                       ...
                       // Số lượng mục trong danh sách dữ liệu
